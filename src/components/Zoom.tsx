...
const Zoom = () => {
    ...
    return (
        <div
            ...
            className={`relative h-full w-full aspect-video m-auto bg-yellow-100 z-20 rounded-xl border-2
                bg-[url('../public/assets/Background/bg_carousel.webp')] bg-no-repeat bg-cover shadow-md`}
        >
            <div
                ref={ref}
                onTouchMove={(e) => handleMouseMove(e)}
                onMouseMove={(e) => handleMouseMove(e)}
                className="min-w-[5rem] w-[20%] aspect-square absolute border-2 border-black shadow-md rounded-full
                    bg-[url('../public/assets/Background/bg_carousel.webp')] bg-no-repeat bg-cover cursor-move bg-yellow-100"
                style={{
